...
**What to build:** Check each declared Python component for undeclared, transitive-only, misclassified, and unused runtime dependencies using its existing dependency declarations. This ticket implements and verifies the source contract; ticket 07 owns release packaging and cross-platform parity for deptry.
...
- [ ] Ticket 07 packages that exact deptry version and proves identical local/CI and Windows/Linux results.
