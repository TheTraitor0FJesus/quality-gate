...
**What to build:** Let a repository declare project-owned web components whose staged JavaScript and CSS assets are checked against consistent per-file and component-wide size budgets. This ticket owns platform-neutral source behavior; ticket 06 owns release-backed Windows/Linux parity.
...
- [ ] Ticket 06 proves identical released check results on Windows and Linux.
